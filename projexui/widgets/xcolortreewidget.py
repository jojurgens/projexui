...
if __name__=='__main__':
    ...
    c1 = XColorTreeWidgetItem('Billy',  [QBrush(QColor(221,88,222)),QBrush(QColor(121,208,122))])
    c1.setData(1, Qt.DisplayRole, 'asdfasdf')
    c1.setData(2, Qt.DisplayRole, 'asdfasdf')

    c2 = XColorTreeWidgetItem('Bobby',  [QBrush(QColor(212,188,162)),QBrush(QColor(191,38,212))])
    c2.setData(1, Qt.DisplayRole, 'asdfasdf')
    c2.setData(2, Qt.DisplayRole, 'sdfasdf')

    c3 = XColorTreeWidgetItem('Larry',  [QBrush(QColor(112,238,62)),QBrush(QColor(154,199,25))])
